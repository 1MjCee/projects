from .UserAdmin import CustomUserAdmin, GuideAdmin, CountryAdmin
from .PromoCodeAdmin import PromoCodeAdmin, SpinnersAdmin
from .InvestmentPlanAdmin import InvestmentPlanAdmin, UserInvestmentPlanAdmin
from .TransactionAdmin import TransactionAdmin
from .WalletAdmin import WalletAdmin, SystemWalletAdmin
from .ReferralsAdmin import ReferralAdmin, ReferralLevelAdmin
